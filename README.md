...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-qgijkk0.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-qgijkk0.containers.anotherwebservice.com/
...
```
git clone git@github.com:ksh2580/container-qgijkk0.git
cd container-qgijkk0
```
...
```
docker attach container-qgijkk0
```
